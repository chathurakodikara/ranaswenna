    ...
    <div class="py-10">
        <div class=" max-w-4xl mx-auto ">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8 ">
                <h3 class="font-bold text-gray-800 text-3xl flex-100 mb-4 pb-2 border-b border-gray-200 ">Update Product
                    Title
                </h3>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-4">
                        ...
                        <div class="w-full md:w-2/3 px-3 mb-3">
                            ...
                            <div class="w-full mb-2 px-3">
                                <x-form-label>
                                    ...
                                    <x-form-input name="img" value="{{$item->img}}" />
                                </x-form-label>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-3 ">
                            <div>
                                <x-form-label>
                                    ...
                                    <x-form-input name="name" value="{{$item->name}}" />
                                </x-form-label>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-3 ">
                            <div>
                                <x-form-label>
                                    ...
                                    <x-form-input name="name_si" value="{{$item->name_si}}" />
                                </x-form-label>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-3 ">
                            <div>
                                <x-form-label>
                                    ...
                                    <x-form-input name="name_ta" value="{{$item->name_ta}}" />
                                </x-form-label>
                        ...
                        <div class="w-full mb-3 px-3">
                            <div>
                                <x-form-label>
                                    <span>Keywords</span>
                                    <x-form-textarea name="keywords">{{$item->keywords}}</x-form-textarea>
                                </x-form-label>
