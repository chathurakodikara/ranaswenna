<div class=" relative px-4">
    <a href="{{ $link }}"
        class=" -mt-2 p-0 w-12 h-12 absolute flex items-center justify-center bg-indigo-600 rounded-full hover:bg-indigo-700 active:shadow-lg shadow transition ease-in duration-200 focus:outline-none">
