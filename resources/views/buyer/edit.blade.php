    ...
    <div class="py-10">
        <div class=" max-w-4xl mx-auto ">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8 ">
                <h3 class="font-bold text-gray-800 text-3xl flex-100 mb-4 pb-2 border-b border-gray-200">Update Purchaser
                </h3>
                ...
                <form method="POST" action="{{ route('buyers.update', $buyer) }}">
                    ...
                    <div class="mb-3">
                        <x-form-label>
                            ...
                            <x-form-input name="business" value="{{ $buyer->business }}" />
                        </x-form-label>
                    ...
                    <div class=" grid sm:grid-cols-2 grid:cols-1 gap-x-6 gap-y-3 mb-3 ">
                        <div>
                            <x-form-label>
                                ...
                                <x-form-input name="registration_no" value="{{ $buyer->registration_no }}" />
                            </x-form-label>
                    ...
                    <div class=" grid sm:grid-cols-2 grid:cols-1 gap-x-6 gap-y-3 mb-3 ">
                        <div>
                            <x-form-label>
                                <span> Telephone *</span>
                                <x-form-input name="telephone" value="{{ $buyer->telephone }}" />
                            </x-form-label>
                        ...
                        <div>
                            <x-form-label>
                                <span>Fax </span>
                                <x-form-input name="fax" value="{{ $buyer->fax }}" />
                            </x-form-label>
                    ...
                    <div class="mb-3">
                        <x-form-label>
                            ...
                            <x-form-textarea name="description">{{ $buyer->description }}</x-form-textarea>
                        </x-form-label>
                    ...
                    <div class="mb-3">
                        <x-form-label>
                            <span>Address *</span>
                            <x-form-textarea name="address">{{ $buyer->address }}</x-form-textarea>
                        </x-form-label>
                    ...
                    <div class="grid sm:grid-cols-4 grid-cols-1 gap-x-6 gap-y-3 mb-3">
                        <x-form-label>
                            ...
                            <x-form-select name="title">
                                <option value="{{ $buyer->title }}">{{ $buyer->title }}</option>
                        ...
                        <x-form-label class=" col-span-3">
                            ...
                            <x-form-input name="contacted_person" value="{{ $buyer->contacted_person }}" />
                        </x-form-label>
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-x-6 gap-y-2 mb-3">
                        <div>
                            <x-form-label>
                                <span>Mobile *</span>
                                <x-form-input name="mobile_1" value="{{ $buyer->mobile_1 }}" />
                            </x-form-label>
                        ...
                        <div>
                            <x-form-label>
                                <span>Mobile</span>
                                <x-form-input name="mobile_2" value="{{ $buyer->mobile_2 }}" />
                            </x-form-label>
                        ...
                        <div>
                            <x-form-label>
                                <span>Email</span>
                                <x-form-input name="email" value="{{ $buyer->email }}" />
                            </x-form-label>
